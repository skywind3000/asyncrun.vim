...
| `macos` | run in a macOS system terminal | macos | [konsole.vim](autoload/asyncrun/runner/macos.vim) |
| `iterm` | run in a new iterm2 tab | macos + iTerm2 | [konsole.vim](autoload/asyncrun/runner/iterm.vim) |
