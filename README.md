...
- 2.2.4 (2020-02-06): exit when starting terminal failed in current window with `-pos=curwin`.
- 2.2.3 (2020-02-06): new `-program=wsl` to run command in wsl (windows 10 only).
